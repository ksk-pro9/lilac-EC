...
( 4, 4,"サンドイッチ１","さんどいっち１","サンドイッチ１の商品詳細",3,100,"./images","sandwich1.jpg",now(),"発売会社",0,now(),now()),
( 5, 5,"サンドイッチ２","さんどいっち２","サンドイッチ２の商品詳細",3,200,"./images","sandwich2.jpg",now(),"発売会社",0,now(),now()),
( 6, 6,"サンドイッチ３","さんどいっち３","サンドイッチ３の商品詳細",3,300,"./images","sandwich3.jpg",now(),"発売会社",0,now(),now()),
( 7, 7,"ベーグル１","べーぐる１","ベーグル１の商品詳細",4,100,"./images","bagle1.jpg",now(),"発売会社",0,now(),now()),
( 8, 8,"ベーグル２","べーぐる２","ベーグル２の商品詳細",4,200,"./images","bagle2.jpg",now(),"発売会社",0,now(),now()),
( 9, 9,"ベーグル３","べーぐる３","ベーグル３の商品詳細",4,300,"./images","bagle3.jpg",now(),"発売会社",0,now(),now()),
( 10, 10,"菓子パン１","かしぱん１","菓子パン１の商品詳細",5,100,"./images","bun1.jpg",now(),"発売会社",0,now(),now()),
( 11, 11,"菓子パン２","かしぱん２","菓子パン２の商品詳細",5,200,"./images","bun2.jpg",now(),"発売会社",0,now(),now()),
( 12, 12,"菓子パン３","かしぱん３","菓子パン３の商品詳細",5,300,"./images","bun3.jpg",now(),"発売会社",0,now(),now())
;
